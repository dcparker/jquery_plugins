...
There are several modes in which you can use this plugin. The simplest may be just transforming a select/options group into a text input with drop-down. $('select').quickselect();
