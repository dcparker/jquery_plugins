jQuery.quickselect = function(input, options){
...
jQuery.fn.quickselect = function(options, data){
  ...
  // options.match = options.match || 'subset';
	...
	this.each(function(){
		...
		if(input.tagName == 'INPUT'){
  		new jQuery.quickselect(input, options);
...
jQuery.fn.quickselectArray = function(data, options){
